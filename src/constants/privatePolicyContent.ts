...
export const PRIVACY_SECTION = {
  ...
  CONTENT1: `➀ 우리는 다음의 목적을 위하여 개인정보를 처리하며, 다음의 목적 이외의 용도로는 개인정보를 이용하지 않습니다. 이용 목적이 변경되는 경우 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.
  ...
  4. 이벤트 응모 등 참여 기회 제공을 위해 개인정보를 처리합니다.
         `,
  TITLE2: '제2조 (개인정보의 보유 및 이용기간)',
  CONTENT2: `① 우리는 이용자의 개인정보를 이용목적에 필요한 기간 내에서 이용 및 보유합니다. 보유기간이 기재되어 있지 않은 경우 우리는 관계법령의 규정에 의한 보존기간까지만 개인정보를 이용합니다. 우리는 보유기간이 종료한 후에는 해당 개인정보를 지체없이 파기합니다.
  ...
  * 탈퇴 방법 : 카카오톡 더보기 > 설정 > 카카오계정 > 연결된 서비스 관리 > 외부 서비스 > 푸앙이 사진관 채널 선택 > 연결 끊기
  ...
  TITLE3: '제3조 (수집하는 개인정보의 항목)',
  CONTENT3: `① 우리는 다음의 개인정보 항목을 처리하고 있습니다.`,
};
export const PRIVACY_SECTION2 = {
  TITLE4: '',
  CONTENT4: `② 제3자로부터 제공받는 개인정보 항목은 다음과 같습니다.
      - 제공하는 업체명: 푸앙이 사진관
  ...
  TITLE5: '제4조 (개인정보의 파기)',
  CONTENT5: `① 우리는 이용자로부터 동의 받은 개인정보의 보유 기간이 경과하거나 처리 목적이 달성되었을 때에는 지체 없이 해당 개인정보를 파기합니다.
  ...
  TITLE6: '제5조 (개인정보의 제3자 제공 및 처리위탁)',
  CONTENT6: `우리는 법령에 규정된 경우를 제외하고는 제3자에게 개인정보를 제공하지 않으며, 제공하게 될 경우 이용자에게 동의를 받겠습니다. 우리는 AI 프로필 서비스 관련 개인정보 처리를 외부에 위탁하고 있지 않습니다.`,
  TITLE7: '제6조 (이용자와 법정대리인의 권리·의무 및 행사방법)',
  CONTENT7: `① 이용자는 우리에게 개인정보 열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다. 이용자의 권리 행사는 전자우편, 서면을 통해 하실 수 있으며 우리는 이에 대해 지체 없이 처리하겠습니다.
  ...
  TITLE8: '제7조 (개인정보의 안전성 확보조치)',
  CONTENT8: `① 우리는 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고 있습니다.
...
export const privacySections3: PrivacySectionProps[] = [
  {
    title: '',
    content: `② 개인정보와 관련한 문의사항 및 의견사항, 서비스 이용 중 개인정보의 유출 가능성 등 정보주체의 권익이 침해될 우려가 있는 사실을 발견하였을 경우에는 위 개인정보 보호책임자 또는 담당 부서에 연락주시면 즉시 조치하여 처리결과를 통보하겠습니다.
  ...
  },
  {
    ...
    content: `본 개인정보처리방침의 변경이 있을 경우 개정 최소 7일 전에 공지를 할 예정입니다. 또한 수집하는 개인정보의 항목,이용목적의 변경 등과 같이 이용자의 중대한 변경이 발생할 필요 시 이용자의 동의를 다시 받을 수도 있습니다.`,
  },
];

...
export const PRIVACY_SECTION = {
  ...
  또한 우리는 만 14세 이상의 이용자를 대상으로 서비스를 제공하며, 만 14세 미만 아동의 개인정보가 수집된 사실을 인지하는 경우 해당 정보를 지체없이 삭제하겠습니다.
  ...
  ② 각각의 개인정보 처리 및 보유기간은 다음과 같습니다.
    ...
    * 탈퇴 방법 : 카카오톡 더보기 > 설정 > 카카오계정 > 연결된 서비스 관리 > 외부 서비스 > 푸앙이 사진관 채널 선택 > 연결 끊기
    2. 재화 또는 서비스 제공  
      ...
      - 결과물 : 서비스 종료 당일까지
    3. 고충처리 : 고충 처리 완료 시까지
    4. 이벤트 응모 : 해당 이벤트 종료시까지 또는 당첨자에게 상품 전달 시까지
    5. 마케팅 활용 : 회원 탈퇴 및 마케팅 활용 동의 철회 시까지 시까지
    6. 다음의 사유에 해당하는 경우에는 해당 기간 종료 시까지
